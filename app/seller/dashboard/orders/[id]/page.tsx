  ...
  if (!order) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[50vh] text-center max-w-md mx-auto">
        ...
        <Link href="/seller/dashboard/orders" className="inline-flex items-center justify-center gap-2 rounded-2xl px-6 py-3 text-[15px] font-bold transition-all shadow-md hover:shadow-lg active:scale-[0.98] bg-[#1A6FD4] text-white hover:bg-[#1559B3]">
                ...
                {orderStatus === "confirmed" && (
                  <>
                    ...
                    <button
                      ...
                      className="w-full inline-flex items-center justify-center gap-2 rounded-2xl px-6 py-4 text-[15px] font-bold transition-all shadow-md active:scale-[0.98] disabled:opacity-50 bg-amber-500 text-white hover:bg-amber-600"
                    >
                ...
                {orderStatus === "processing" && (
                  <>
                    ...
                    <button
                      ...
                      className="w-full inline-flex items-center justify-center gap-2 rounded-2xl px-6 py-4 text-[15px] font-bold transition-all shadow-md active:scale-[0.98] disabled:opacity-50 bg-[#1A6FD4] text-white hover:bg-[#1559B3]"
                    >
                ...
                {orderStatus === "shipped" && (
                  <>
                    ...
                    <button
                      ...
                      className="w-full inline-flex items-center justify-center gap-2 rounded-2xl px-6 py-4 text-[15px] font-bold transition-all shadow-md active:scale-[0.98] disabled:opacity-50 bg-green-600 text-white hover:bg-green-700"
                    >

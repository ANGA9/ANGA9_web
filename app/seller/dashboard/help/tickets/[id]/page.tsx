...
export default function SellerTicketDetailPage() {
  ...
  if (error || !detail) {
    return (
      <main className="mx-auto max-w-3xl px-4 py-6">
        <Link href="/seller/dashboard/help/tickets" className="inline-flex items-center gap-1 text-sm text-[#1A6FD4]">
  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-6 md:py-10 text-[#1A1A2E]">
      <Link href="/seller/dashboard/help/tickets" className="inline-flex items-center gap-1 text-sm text-[#1A6FD4]">
      ...
      {showCsat && (
        <section className="mt-6 rounded-xl border border-[#E8EEF4] bg-white p-4">
          ...
          <button
            ...
            className="mt-2 rounded-xl px-5 py-2.5 text-[14px] font-bold disabled:opacity-50 bg-[#1A6FD4] text-white hover:bg-[#1559B3] shadow-sm transition-all"
          >

  ...
  return (
    <>
      <header className="sticky top-0 z-40 w-full bg-white/95 backdrop-blur-md border-b border-[#E8EEF4] shadow-sm">
        <div className="mx-auto flex h-[64px] sm:h-[72px] max-w-[1400px] items-center justify-between px-4 sm:px-6 lg:px-12">
          {/* Logo */}
          <Link href="/" className="shrink-0 transition-opacity hover:opacity-80 flex items-center gap-2">
            <Image 
              src="/anga9-logo.png" 
              alt="ANGA9 Logo" 
              width={100} 
            ...
            />
            <span className="hidden sm:inline-block border-l-2 border-[#E8EEF4] pl-3 ml-1 text-sm font-bold text-[#4B5563] tracking-wide">
              SELLER HUB
            </span>
          </Link>
                ...
                <Link 
                  ...
                  className={`text-[15px] font-semibold transition-all pb-1 border-b-2 ${
                    isActive 
                      ...
                      : "text-[#4B5563] border-transparent hover:text-[#4338CA]"
                  }`}
                >
                  {item.name}
                </Link>
          ...
          <div className="flex items-center gap-3 lg:gap-4">
            <Link 
              href="/seller/login" 
              className="hidden sm:inline-flex rounded-lg border border-[#1A1A2E] px-5 py-2 text-sm font-bold text-[#1A1A2E] transition-all hover:bg-gray-50"
            >
              Login
            </Link>
            <Link 
            ...
            {/* Mobile Menu Toggle */}
            <button 
              className="p-2 -mr-2 lg:hidden text-[#1A1A2E] hover:bg-[#F3F4F6] rounded-lg transition-colors" 

    ...
    <>
        ...
        <div className="mx-auto flex h-[64px] sm:h-[72px] max-w-[1400px] items-center justify-between px-3 sm:px-6 lg:px-12">
          ...
          <div className="flex items-center gap-2 lg:gap-4">
            ...
            <SellerLink
              ...
              className="hidden lg:inline-flex h-[42px] items-center justify-center rounded-lg px-6 text-sm font-bold shadow-sm transition-all hover:-translate-y-[1px] bg-white border-2 border-[#4338CA] text-[#4338CA] hover:bg-gray-50"
            >
              Start Selling
            </SellerLink>
      ...
      >
        ...
        <div className="p-5 border-t border-[#E8EEF4] bg-white flex flex-col gap-3">
          ...
          <SellerLink
            href="/seller/register"
            className="flex items-center justify-center gap-2 w-full h-[52px] rounded-xl font-bold text-base shadow-sm transition-colors bg-white border-2 border-[#4338CA] text-[#4338CA] hover:bg-gray-50"
            onClick={() => setIsMenuOpen(false)}
          >

      ...
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-10">
        ...
        <div className="lg:hidden pb-10">
          <button
            ...
            form="ad-form"
            disabled={loading}
            className="w-full inline-flex items-center justify-center gap-2 rounded-2xl px-6 py-4 text-[16px] font-bold transition-all shadow-md active:scale-[0.98] disabled:opacity-50 bg-[#1A6FD4] text-white hover:bg-[#1559B3]"
          >
            {loading ? <Loader2 className="w-5 h-5 animate-spin" /> : "Submit for Review"}
          </button>
        </div>

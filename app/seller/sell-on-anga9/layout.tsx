...
export const metadata: Metadata = {
  ...
  description:
    "Join 10,000+ sellers on ANGA9, India's leading B2B wholesale marketplace. List products, reach 19,000+ pin codes, and grow your wholesale business at 10% commission.",
  alternates: { canonical: "https://seller.anga9.com/sell-on-anga9" },
  openGraph: {
    title: "Become a Seller on ANGA9 — 10% Commission B2B Marketplace",
    description:
      "Sell on India's fastest-growing B2B marketplace at 10% commission. Reach verified retailers across 19,000+ pin codes.",
...
const webPageLd = {
  ...
  about: {
    ...
    offers: {
      ...
      price: "0",
      priceCurrency: "INR",
      description: "10% commission on seller listings",
    },
  },
};
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "ANGA9 charges 10% commission on seller listings, making it one of the most seller-friendly B2B wholesale marketplaces in India.",
      },
    },
    {
      "@type": "Question",

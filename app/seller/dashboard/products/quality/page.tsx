    ...
    <main className="w-full mx-auto max-w-5xl px-4 py-8">
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-3xl border border-gray-200 p-10 text-center">
          ...
          <Link href="/seller/dashboard/products/new" className="inline-flex px-6 py-2.5 rounded-xl font-bold bg-[#1A6FD4] text-white hover:bg-[#1559B3]">
            Add Product
          </Link>
        </div>
      ) : (
                  ...
                  <div key={p.id} className="p-6 flex flex-col sm:flex-row gap-6 hover:bg-gray-50/50 transition-colors">
                    ...
                    <div className="sm:w-32 flex sm:flex-col items-center justify-center shrink-0">
                      <Link
                        ...
                        className="w-full flex items-center justify-center gap-1 px-4 py-2.5 text-[14px] font-bold rounded-xl transition-colors bg-[#1A6FD4] text-white hover:bg-[#1559B3]"
                      >

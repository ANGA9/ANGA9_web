    ...
    <main className="w-full mx-auto max-w-6xl px-3 sm:px-4 py-6 md:px-8 md:py-10 text-[#1A1A2E]">
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
        ...
        <button
          ...
          className="inline-flex items-center justify-center gap-2 rounded-2xl bg-[#1A6FD4] px-6 py-3.5 text-[15px] font-bold text-white transition-all shadow-md hover:shadow-lg hover:bg-[#155bb5] active:scale-[0.98]"
        >
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <div className="flex items-center gap-2">
                          ...
                          {isActive && (
                            <span className="flex items-center gap-1 text-[11px] font-bold text-[#1A6FD4] bg-[#1A6FD4]/10 px-2 py-0.5 rounded-full uppercase tracking-wider">

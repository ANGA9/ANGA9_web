...
export default function DashboardHome() {
  ...
  // ΓöÇΓöÇ Onboarding / Unverified State ΓöÇΓöÇ
  if (status !== "verified") {
          ...
          {status === "pending" && (
            <div className="w-full max-w-sm mt-4 pt-8 border-t border-yellow-200 flex justify-between relative">
              ...
              <div className="flex flex-col items-center gap-3 bg-yellow-50/50 px-2">
                <div className="w-8 h-8 rounded-full bg-green-500 text-white flex items-center justify-center font-bold shadow-sm">Γ£ô</div>

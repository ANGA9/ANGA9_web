...
const labelCls = "block text-sm md:text-base font-normal text-[#1A1A2E] mb-1.5";
const inputCls = "h-11 w-full rounded-lg border border-[#9CA3AF] bg-white px-4 text-sm text-[#1A1A2E] placeholder:text-[#9CA3AF] focus:border-[#1A6FD4] focus:outline-none focus:ring-2 focus:ring-[#1A6FD4]/10 transition-colors";

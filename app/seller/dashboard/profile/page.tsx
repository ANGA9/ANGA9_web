...
export default function ProfilePage() {
  ...
  return (
    <div className="max-w-[580px]">
      <h1 className="text-[20px] font-bold text-[#1A1A2E] mb-1">Business Profile</h1>
      <p className="text-[13px] text-[#9CA3AF] mb-6">Update your business information</p>
      <div className="bg-white rounded-xl border border-[#E8EEF4] p-6 space-y-5">
        ...
        {saved && <p className="text-[13px] text-[#22C55E] font-medium">✓ Profile saved successfully</p>}
      </div>
    </div>
  );
}
